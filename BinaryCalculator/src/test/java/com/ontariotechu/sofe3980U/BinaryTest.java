...
public class BinaryTest
{
    ...
    public void OR2()
    {
        Binary binary1=new Binary("01010001");
        Binary binary2=new Binary("0011");
        Binary binary3=Binary.OR(binary1,binary2);
        assertTrue(binary3.getValue().equals("1010011"));
    }

    /**
     * Test The OR function with two binary numbers and one is 0
     */
    @Test
    public void OR3()
    {
        ...
        Binary binary2=new Binary("0");
        Binary binary3=Binary.OR(binary1,binary2);
        assertTrue(binary3.getValue().equals("1010101"));
    }
    ...
    {
        Binary binary1=new Binary("10101");
        Binary binary2=new Binary("10100010011");
        Binary binary3=Binary.AND(binary1,binary2);
        assertTrue(binary3.getValue().equals("10001"));
    }

    /**
     * Test The AND function with two binary numbers and one of them is 0
     */
    @Test
    public void AND3()
    {
    ...
    public void multiply()
    {
        ...
        assertTrue(binary3.getValue().equals("101101"));
    }
    ...
    {
        Binary binary1=new Binary("1010001");
        Binary binary2=new Binary("101");
        Binary binary3=Binary.multiply(binary1,binary2);
        assertTrue(binary3.getValue().equals("110010101"));
    }

    /**
     * Test The multiply function with two binary numbers and one of them is 0
     */
    @Test
